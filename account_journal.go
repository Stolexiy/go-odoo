...
type AccountJournal struct {
	...
	HasSepaCtPaymentMethod        *Bool       `xmlrpc:"has_sepa_ct_payment_method,omitempty"`
	...
	LoanPropertiesDefinition      interface{} `xmlrpc:"loan_properties_definition,omitempty"`
	...
	QifDateFormat                 *Selection  `xmlrpc:"qif_date_format,omitempty"`
	QifDecimalPoint               *String     `xmlrpc:"qif_decimal_point,omitempty"`
