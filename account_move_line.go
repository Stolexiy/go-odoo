...
type AccountMoveLine struct {
	...
	IntrastatProductOriginCountryId *Many2One   `xmlrpc:"intrastat_product_origin_country_id,omitempty"`
	...
	XStudioCharFieldTGc8Q           *String     `xmlrpc:"x_studio_char_field_tGc8q,omitempty"`
	XStudioTiquettes                *Selection  `xmlrpc:"x_studio_tiquettes,omitempty"`
}
