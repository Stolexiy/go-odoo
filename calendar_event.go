...
type CalendarEvent struct {
	...
	AppointmentBookerId            *Many2One  `xmlrpc:"appointment_booker_id,omitempty"`
	...
	AppointmentStatus              *Selection `xmlrpc:"appointment_status,omitempty"`
	AppointmentTypeId              *Many2One  `xmlrpc:"appointment_type_id,omitempty"`
	AppointmentTypeManageCapacity  *Bool      `xmlrpc:"appointment_type_manage_capacity,omitempty"`
	AppointmentTypeScheduleBasedOn *Selection `xmlrpc:"appointment_type_schedule_based_on,omitempty"`
	...
	OnLeavePartnerIds              *Relation  `xmlrpc:"on_leave_partner_ids,omitempty"`
	OnLeaveResourceIds             *Relation  `xmlrpc:"on_leave_resource_ids,omitempty"`
	...
	ResourceTotalCapacityReserved  *Int       `xmlrpc:"resource_total_capacity_reserved,omitempty"`
	ResourceTotalCapacityUsed      *Int       `xmlrpc:"resource_total_capacity_used,omitempty"`
	...
	VideocallRedirection           *String    `xmlrpc:"videocall_redirection,omitempty"`
