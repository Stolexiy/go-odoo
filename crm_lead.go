...
type CrmLead struct {
	...
	XStudioEquipmentBrand           *String     `xmlrpc:"x_studio_equipment_brand,omitempty"`
	XStudioEquipmentModel           *String     `xmlrpc:"x_studio_equipment_model,omitempty"`
	XStudioLastReadyEmailSent       *Time       `xmlrpc:"x_studio_last_ready_email_sent,omitempty"`
	XStudioModeDePaiement           *Selection  `xmlrpc:"x_studio_mode_de_paiement,omitempty"`
	XStudioPay                      *Bool       `xmlrpc:"x_studio_pay,omitempty"`
	XStudioRepairStatus             *Selection  `xmlrpc:"x_studio_repair_status,omitempty"`
	XStudioRetour                   *Bool       `xmlrpc:"x_studio_retour,omitempty"`
	XStudioTechnician               *Relation   `xmlrpc:"x_studio_technician,omitempty"`
