...
type PosOrder struct {
	...
	L10NFrHash                 *String    `xmlrpc:"l10n_fr_hash,omitempty"`
	L10NFrSecureSequenceNumber *Int       `xmlrpc:"l10n_fr_secure_sequence_number,omitempty"`
	L10NFrStringToHash         *String    `xmlrpc:"l10n_fr_string_to_hash,omitempty"`
	...
	PosVersion                 *String    `xmlrpc:"pos_version,omitempty"`
	PreviousOrderId            *Many2One  `xmlrpc:"previous_order_id,omitempty"`
	...
	XStudioIntegerFieldWeUE1   *Int       `xmlrpc:"x_studio_integer_field_WeUE1,omitempty"`
	XStudioOlProductBarcode    *String    `xmlrpc:"x_studio_ol_product_barcode,omitempty"`
	XStudioOlProductName       *String    `xmlrpc:"x_studio_ol_product_name,omitempty"`
	XStudioTextFieldXLqkP      *String    `xmlrpc:"x_studio_text_field_XLqkP,omitempty"`
	XStudioTextFieldM2JTy      *String    `xmlrpc:"x_studio_text_field_m2jTy,omitempty"`
}
