...
type ProductCategory struct {
	...
	XStudioCharFieldP2JOf                       *String     `xmlrpc:"x_studio_char_field_p2JOf,omitempty"`
	XStudioCondition                            *Selection  `xmlrpc:"x_studio_condition,omitempty"`
	XStudioDiscogsFolderId                      *Int        `xmlrpc:"x_studio_discogs_folder_id,omitempty"`
	XStudioNumberOfVinyls                       *Int        `xmlrpc:"x_studio_number_of_vinyls,omitempty"`
	XStudioPurchasePrice                        *Float      `xmlrpc:"x_studio_purchase_price,omitempty"`
	XStudioUnitPrice                            *Float      `xmlrpc:"x_studio_unit_price,omitempty"`
}
