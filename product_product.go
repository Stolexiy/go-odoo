...
type ProductProduct struct {
	...
	IntrastatSupplementaryUnitAmount       *Float      `xmlrpc:"intrastat_supplementary_unit_amount,omitempty"`
	...
	XStudioArtists                         *String     `xmlrpc:"x_studio_artists,omitempty"`
	XStudioArtists3                        *Relation   `xmlrpc:"x_studio_artists3,omitempty"`
	XStudioArtists1                        *String     `xmlrpc:"x_studio_artists_1,omitempty"`
	XStudioCharFieldC6Cg6                  *String     `xmlrpc:"x_studio_char_field_C6Cg6,omitempty"`
	XStudioCharFieldGG7SU                  *String     `xmlrpc:"x_studio_char_field_GG7sU,omitempty"`
	XStudioCharFieldXgKQ0                  *String     `xmlrpc:"x_studio_char_field_XgKQ0,omitempty"`
	XStudioCharFieldYwxuy                  *String     `xmlrpc:"x_studio_char_field_Ywxuy,omitempty"`
	XStudioCharFieldJt0OE                  *String     `xmlrpc:"x_studio_char_field_jt0OE,omitempty"`
	XStudioCharFieldML2Po                  *String     `xmlrpc:"x_studio_char_field_mL2Po,omitempty"`
	XStudioCharFieldVa7IB                  *String     `xmlrpc:"x_studio_char_field_va7iB,omitempty"`
	XStudioCharFieldXZFU2                  *String     `xmlrpc:"x_studio_char_field_xZFU2,omitempty"`
	XStudioCollection                      *Relation   `xmlrpc:"x_studio_collection,omitempty"`
	XStudioCollectionId                    *String     `xmlrpc:"x_studio_collection_id,omitempty"`
	XStudioCountry                         *Relation   `xmlrpc:"x_studio_country,omitempty"`
	...
	XStudioMany2ManyFieldDkKij             *Relation   `xmlrpc:"x_studio_many2many_field_DkKij,omitempty"`
	XStudioMany2ManyFieldGj4OK             *Relation   `xmlrpc:"x_studio_many2many_field_Gj4OK,omitempty"`
	XStudioMany2ManyFieldLdYkA             *Relation   `xmlrpc:"x_studio_many2many_field_LdYkA,omitempty"`
	XStudioMany2ManyFieldMC7Xf             *Relation   `xmlrpc:"x_studio_many2many_field_MC7Xf,omitempty"`
	XStudioMany2ManyFieldPbGXA             *Relation   `xmlrpc:"x_studio_many2many_field_PbGXA,omitempty"`
	XStudioMany2ManyFieldT0UBA             *Relation   `xmlrpc:"x_studio_many2many_field_T0UBA,omitempty"`
	XStudioMany2ManyFieldFroCV             *Relation   `xmlrpc:"x_studio_many2many_field_froCV,omitempty"`
	XStudioMany2ManyFieldH9EBT             *Relation   `xmlrpc:"x_studio_many2many_field_h9EBT,omitempty"`
	XStudioMany2ManyFieldKoBkM             *Relation   `xmlrpc:"x_studio_many2many_field_koBkM,omitempty"`
	XStudioMany2ManyFieldVlIm5             *Relation   `xmlrpc:"x_studio_many2many_field_vlIm5,omitempty"`
	XStudioMediaCondition                  *Selection  `xmlrpc:"x_studio_media_condition,omitempty"`
	XStudioMultilineNotes                  *String     `xmlrpc:"x_studio_multiline_notes,omitempty"`
	XStudioNotes                           *String     `xmlrpc:"x_studio_notes,omitempty"`
	XStudioNotes1                          *String     `xmlrpc:"x_studio_notes_1,omitempty"`
	XStudioOne2ManyFieldMkcRR              *Relation   `xmlrpc:"x_studio_one2many_field_MkcRR,omitempty"`
	XStudioProductFormat                   *Selection  `xmlrpc:"x_studio_product_format,omitempty"`
	XStudioRelease                         *Relation   `xmlrpc:"x_studio_release,omitempty"`
	XStudioReleaseId                       *String     `xmlrpc:"x_studio_release_id,omitempty"`
	XStudioReleasePage                     *String     `xmlrpc:"x_studio_release_page,omitempty"`
	XStudioSelectionField8BqT6             *Selection  `xmlrpc:"x_studio_selection_field_8BqT6,omitempty"`
	XStudioSelectionFieldXvIp6             *Selection  `xmlrpc:"x_studio_selection_field_XvIp6,omitempty"`
	XStudioSelectionFieldNvsHl             *Selection  `xmlrpc:"x_studio_selection_field_nvsHl,omitempty"`
	XStudioSleeveCondition                 *Selection  `xmlrpc:"x_studio_sleeve_condition,omitempty"`
	XStudioStyles                          *Relation   `xmlrpc:"x_studio_styles,omitempty"`
	XStudioTextFieldHpNtT                  *String     `xmlrpc:"x_studio_text_field_HpNtT,omitempty"`
	XStudioTextFieldCt2Dp                  *String     `xmlrpc:"x_studio_text_field_ct2dp,omitempty"`
	XStudioYearOfTheRelease                *String     `xmlrpc:"x_studio_year_of_the_release,omitempty"`
	XStudioYearOfTheReleaseOfTheMaster     *String     `xmlrpc:"x_studio_year_of_the_release_of_the_master,omitempty"`
	XStudioYearRelease                     *String     `xmlrpc:"x_studio_year_release,omitempty"`
}
