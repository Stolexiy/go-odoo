...
type ProjectProject struct {
	...
	DisplayPlanningTimesheetAnalysis *Bool       `xmlrpc:"display_planning_timesheet_analysis,omitempty"`
	...
	TotalBudgetAmount                *Float      `xmlrpc:"total_budget_amount,omitempty"`
	TotalBudgetProgress              *Float      `xmlrpc:"total_budget_progress,omitempty"`
	TotalForecastTime                *Int        `xmlrpc:"total_forecast_time,omitempty"`
