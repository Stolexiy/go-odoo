...
type PurchaseOrder struct {
	...
	AmountTotalCc                *Float     `xmlrpc:"amount_total_cc,omitempty"`
	...
	IsAnalytic                   *Bool      `xmlrpc:"is_analytic,omitempty"`
	...
	PartnerBillCount             *Int       `xmlrpc:"partner_bill_count,omitempty"`
