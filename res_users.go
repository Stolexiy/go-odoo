...
type ResUsers struct {
	...
	UpcomingAppointmentIds              *Relation  `xmlrpc:"upcoming_appointment_ids,omitempty"`
	...
	XStudioClientDe                     *Selection `xmlrpc:"x_studio_client_de,omitempty"`
	XStudioSelectionFieldSGQsW          *Selection `xmlrpc:"x_studio_selection_field_sGQsW,omitempty"`
