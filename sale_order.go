...
type SaleOrder struct {
	...
	PlanningFirstSaleLineId      *Many2One   `xmlrpc:"planning_first_sale_line_id,omitempty"`
	PlanningHoursPlanned         *Float      `xmlrpc:"planning_hours_planned,omitempty"`
	PlanningHoursToPlan          *Float      `xmlrpc:"planning_hours_to_plan,omitempty"`
	PlanningInitialDate          *Time       `xmlrpc:"planning_initial_date,omitempty"`
	...
	XStudioMany2ManyFieldApJ3W   *Relation   `xmlrpc:"x_studio_many2many_field_ApJ3W,omitempty"`
	XStudioMany2ManyFieldD1OXb   *Relation   `xmlrpc:"x_studio_many2many_field_D1oXb,omitempty"`
	XStudioMany2ManyFieldIbQqF   *Relation   `xmlrpc:"x_studio_many2many_field_ibQqF,omitempty"`
	XStudioMany2ManyFieldOis22   *Relation   `xmlrpc:"x_studio_many2many_field_ois22,omitempty"`
	XStudioMany2ManyFieldY6Y46   *Relation   `xmlrpc:"x_studio_many2many_field_y6y46,omitempty"`
	XStudioMany2ManyFieldYTyoq   *Relation   `xmlrpc:"x_studio_many2many_field_yTyoq,omitempty"`
}
